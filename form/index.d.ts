...
export { default as useRequiredInputValidator } from './hooks/use-required-input-validator';
...
export { default as SwitchButton, IOSSwitchButton, coloredIOSSwitchButton } from './components/SwitchButton';
