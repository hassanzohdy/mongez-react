...
function getRouteImports(component, command) {
    let content = `import ${component} from './components/${component}/Page';`;
...
module.exports = function updateRoutesFile(moduleDirectory, route, component, command) {
    ...
    routeContent = routeContent.replace('// module-imports', getRouteImports(component, command));
