...
export default function ImageInput({ required = false, clearButton = null, clearButtonPosition = 'bottom', height = null, width = null, name = '', imageStyle = {}, ...props }) {
    ...
    return (
        <>
            {imageFileInput}
            <If condition={Boolean(clearButtonPosition === 'bottom' && (selectedImage && selectedImage !== imagePlaceholder))}>
