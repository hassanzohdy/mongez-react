const initConfig = {
  height: 500,
  contextmenu: 'copy cut paste spellchecker | link image table | align italic bold underline strikethrough forecolor backcolor lineheight blockformats codeformat fontformats fontsizes subscript superscript formats | undo redo removeformat selectall',
  ...
  toolbar:
    "spellchecker | formatselect | fontselect | fontsizeselect | " +
