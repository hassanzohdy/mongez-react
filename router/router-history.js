import { Obj, rtrim, ltrim } from 'reinforcements';
import config from '../config/index.js';
import queryStringParser from 'query-string';
import { createBrowserHistory } from 'history';

const BASE_NAME = process.env.NODE_ENV === 'production' ? config.get('basePath', '/') : '/';
const BASE_URL = rtrim(window.location.origin + BASE_NAME, '/');
...
export { BASE_NAME, BASE_URL, hash, queryString };
