...
import SwitchButton from '../../../form/components/SwitchButton.js';

function SwitchFormatter({ record, column }) {
    ...
    return React.createElement(SwitchComponent, { defaultChecked: value, onChange: onSwitching });
}

export default SwitchFormatter;
